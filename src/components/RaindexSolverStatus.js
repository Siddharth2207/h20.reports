                    ...
                    <table className="min-w-full table-auto rounded-lg border border-gray-200 text-left shadow-sm">
                      <thead className="bg-gray-100 text-sm uppercase text-gray-700">
                        <tr>
                          ...
                          <th className="w-[200px] break-words px-4 py-2">Order Log</th>
                        </tr>
                      </thead>
...
const RaindexSolverStatus = () => {
  ...
  const [filteredSolverLogs, setFilteredSolverLogs] = useState(null);
  ...
  // New handler for order hash input
  const handleOrderHashChange = (event) => {
    setSelectedOrderHash(event.target.value);
  };
    ...
    <div className="min-h-screen p-6">
        ...
        <div className="flex items-center space-x-4">
          ...
          <div className="flex items-center space-x-2">
            ...
            <input
              ...
              className="rounded bg-gray-700 p-2 text-sm text-white placeholder-gray-400 focus:outline-none focus:ring focus:ring-indigo-500"
      ...
      <div className="max-w-screen-3xl mx-auto mt-6 rounded-lg bg-gray-100 p-8 shadow-lg">
        {loadingSolverLogs ? (
          ...
          <>{filteredSolverLogs && <OrdersTable orderSolverLogs={filteredSolverLogs} />}</>
        )}
